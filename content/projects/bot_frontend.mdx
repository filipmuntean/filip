...
The **topic clustering** bubble chart groups questions by embedding similarity, with bubble area standing in for cluster size. Clicking a bubble opens the questions inside it, or drills into sub-clusters — so "what is the cohort actually stuck on this week" is a couple of clicks rather than a query.
